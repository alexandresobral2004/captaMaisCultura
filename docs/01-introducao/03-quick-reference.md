...
> **📍 Localização:** `docs/01-introducao/03-quick-reference.md`
...
│   ├── pipeline.ts             (process single/batch editais)
...
### Storage
- Database: 147 editais in 461 KB JSON
...
### Issue: False positives (non-IT editais marked valid)
...
**Reason:** All 102 analyzed editais require human approval
...
- **Arquitetura completa:** [`../02-arquitetura/01-architecture-summary.md`](../02-arquitetura/01-architecture-summary.md)
- **Mapa do projeto:** [`../02-arquitetura/02-mapa-projeto.md`](../02-arquitetura/02-mapa-projeto.md)
- **Análise de token waste:** [`../08-testes-analise/03-token-waste-analysis.md`](../08-testes-analise/03-token-waste-analysis.md)
